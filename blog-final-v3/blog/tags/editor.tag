<editor>
  ...
  <div class="row">
    <input class="six columns" type="text" ref="post_author" placeholder="Author" value={post ? post.author : ''}>
    <input class="six columns" type="text" ref="post_category" placeholder="Category" value={post ? post.category : ''}>
  </div>
